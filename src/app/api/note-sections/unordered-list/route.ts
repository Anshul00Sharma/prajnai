...
import { editUnorderedList } from "@/lib/gemini";
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Call Gemini AI to edit the unordered list
    const editedItems = await editUnorderedList({
      context: contextText,
      body: itemsText,
    ...
    console.error("Error in unordered list editing API:", error);
    return NextResponse.json(
      { 
        error: "Failed to edit unordered list", 
